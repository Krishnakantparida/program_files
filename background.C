               ...
               const std::vector<std::string>& branch_names)
{
    ...
    // Loop over the entries in the input tree and fill the output tree with the selected branches
...
void background()
{
    ...
    std::string input_file_name = "output_TTGG_0Jets_pythia8.root";
    std::string output_file_name = "background_file.root";
    std::string tree_name = "/tagsDumper/trees/ttgg_13TeV_THQLeptonicTag";
